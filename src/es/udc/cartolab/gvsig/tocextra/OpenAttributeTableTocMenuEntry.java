...
import com.iver.cit.gvsig.ShowTable;
 ...
 * 
 */
public class OpenAttributeTableTocMenuEntry extends AbstractTocContextMenuAction {

	
	public String getText() {
		return PluginServices.getText(this, "ver_tabla_atributos");
	}
	...
	public void execute(ITocItem item, FLayer[] selectedItems) {
		...
		IExtension extension = PluginServices.getExtension(ShowTable.class);
		extension.execute(new String());
